...
class PeriodFDV4(nn.Module):
    """Period FD V4 first substract main frequecy component from the original series, then san

    Args:
        nn (_type_): _description_
    """
    def __init__(self,  seq_len, pred_len, enc_in, freq_topk = 6 ):
        super().__init__()
    ...
    def denormalize(self, input_norm):
        ...
        output = output + self.pred_main_freq_signal
